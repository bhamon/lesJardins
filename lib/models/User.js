...
class User extends lib.odin.Model {
	...
	*/
	...
	[lib.odin.Model.SYMBOL_METHOD_POPULATE](p_data) {
		...
		let rights = lib.odin.util.validate(p_data.rights, lib.deps.joi.array().optional().default([]));
	...
	*/
	...
	/**
		@desc									Sets the provided rights to this user.
		@param {Array.<String>} p_rights		Rights list.
	*/
	setRights(p_rights) {
